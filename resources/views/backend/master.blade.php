...
<html lang="en">
  ...
  <body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href="{{ url('dashboard') }}"><i class="icon ion-android-star-outline"></i> starlight</a></div>
      ...
      <div class="sl-sideleft-menu">
        <a href="{{ url('dashboard') }}" class="sl-menu-link active">
          ...
          <ul class="sl-menu-sub nav flex-column" style="display: block;">
            <li class="nav-item"><a href="{{ url('admin/category') }}" class="nav-link">Category Lists</a></li>
            <li class="nav-item"><a href="{{ url('admin/add_category') }}" class="nav-link">Add Category</a></li>
            <li class="nav-item"><a href="{{ url('admin/add_category') }}" class="nav-link">Trash</a></li>
          </ul>
