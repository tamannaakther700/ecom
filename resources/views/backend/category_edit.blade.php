...
<div class="sl-mainpanel">
    ...
    <div class="sl-pagebody">
        <div class="row row-sm">
            <div class="col-12">
                <h6 class="card-body-title text-center pb-5">Edit Category</h6>   
            </div>
            <div class="col-xl-10 m-auto mg-t-25  mg-xl-t-0">
                <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
                    ...
                    <div class="row">
                        ...
                        <input type="text" class="form-control @error('category_name')  is-validate @enderror" value="{{  $category->category_name ?? old('category_name') }}" placeholder="Enter Category Name" name="category_name">
                        @error('category_name')
